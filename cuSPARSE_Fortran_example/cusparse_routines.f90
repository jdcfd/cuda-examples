module cusparse_routines
    ...
    interface cusparse_mv
        procedure cusparse_mv_double, cusparse_mv_float
    end interface

    contains 

    subroutine cusparse_mv_float(nrows, ncols, nnz, csrOffsets, columns, values, x, y, alpha, beta, time_setup, time_spmv)
        implicit none
    ...
    end subroutine cusparse_mv_float

    subroutine cusparse_mv_double(nrows, ncols, nnz, csrOffsets, columns, values, x, y, alpha, beta, time_setup, time_spmv)
        implicit none
        integer, intent(in) :: nrows, ncols, nnz
        integer, dimension(nrows+1), intent(in):: csrOffsets 
        integer, dimension(nnz), intent(in) :: columns 
    ...
    end subroutine cusparse_mv_double
